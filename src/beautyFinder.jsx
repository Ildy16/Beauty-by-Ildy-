...
const C={
 hu:{
  ...
  deviceTitle:'A készülékág következő modulja',deviceText:'A technológiai célod alapján később külön készülék-szintű ellenjavallat-ellenőrzést végzünk. Addig a Beauty Tech útmutatóban hasonlíthatod össze az RF, LED, mikroáram és más technológiákat.',deviceCta:'BEAUTY TECH ÚTMUTATÓ',wellnessTitle:'Wellness – biztonságosan, bizonyítékokkal',wellnessText:'A Beauty by Ildy wellness-válogatását most külön tudástárban építjük. Addig nem adunk automatikus étrend-kiegészítő ajánlást: a Wellness oldalon a bizonyítékokat, korlátokat és biztonsági szempontokat nézheted át.',wellnessCta:'WELLNESS ÚTMUTATÓ',
 ...
 en:{
  ...
  deviceTitle:'The device module comes next',deviceText:'Device-level recommendations need model-specific contraindication checks. Until then, use the Beauty Tech guide to compare RF, LED, microcurrent and other technologies.',deviceCta:'BEAUTY TECH GUIDE',wellnessTitle:'Wellness — evidence first',wellnessText:'The Beauty by Ildy wellness edit is being built as a separate evidence-led knowledge area. Until the compliant product catalogue is complete, we do not generate automated supplement recommendations. Use the Wellness guide for evidence, limitations and safety context.',wellnessCta:'WELLNESS GUIDE',
 ...
 de:{
  ...
  deviceTitle:'Das Gerätemodul folgt als nächstes',deviceText:'Geräteempfehlungen brauchen modellbezogene Kontraindikationsprüfungen. Bis dahin kannst du im Beauty-Tech-Guide RF, LED, Mikrostrom und weitere Technologien vergleichen.',deviceCta:'BEAUTY-TECH-GUIDE',wellnessTitle:'Wellness — evidenzbasiert und sicher',wellnessText:'Die Beauty-by-Ildy-Wellness-Auswahl wird als eigener evidenzbasierter Wissensbereich aufgebaut. Bis der regelkonforme Produktkatalog vollständig ist, geben wir keine automatischen Supplement-Empfehlungen. Im Wellness-Guide findest du Evidenz, Grenzen und Sicherheitshinweise.',wellnessCta:'WELLNESS-GUIDE',
