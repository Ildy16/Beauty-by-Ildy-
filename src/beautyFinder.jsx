...
function FinderCompare({results,t,lang}){
 ...
 return <section className="finderCompare"><h2>{t.compareTitle}</h2><p>{t.compareLead}</p><div className="finderCompareGrid">{items.map(item=><article key={item.product.slug}>
...
export function BeautyFinder({lang='hu'}){
 ...
 if(showResult){
  ...
  return <main className="finderPage">
   ...
   <section className="finderResults" aria-live="polite">
